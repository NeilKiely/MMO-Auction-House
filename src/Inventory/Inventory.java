...
public class Inventory {
    ...
    public String findItemToStringInformation(String itemName) {
        String result = getItem(findIndexOfItem(itemName)).toStringToFile();
        return result;
    }
    ...
    public void removeItem(String itemName){
        removeItem(findIndexOfItem(itemName));
    }
}
